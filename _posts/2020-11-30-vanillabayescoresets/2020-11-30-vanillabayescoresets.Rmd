...
As part of a course project, [Rachel Longjohn](https://github.com/rlongjohn) and I have written an R package named `vanillabayescoresets` for implementing [Bayesian coresets](https://arxiv.org/abs/1710.05053) for binary logistic regression data in R. 
...
In this article you can read some information about `vanillabayescoresets`. The [package](https://github.com/stats295r-fa20/package-group8) and its [vignette](https://github.com/stats295r-fa20/package-group8/blob/main/vignettes/vanilla-bayesian-coresets.Rmd) are available on GitHub.
